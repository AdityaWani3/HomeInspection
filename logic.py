...
"""
    ...
    def _add_footer(self, doc):
        ...
        run._r.append(fldChar)
    def chat_with_inspector(self, user_query):
        """
        Respond to a user's question based on the generated report.
        """
        import google.generativeai as genai

        if not hasattr(self, 'report'):
            raise ValueError("No report found. Please generate the inspection report first.")
        ...
        report_context = json.dumps(self.report, indent=2)

        # Combine context and question
        prompt = f"""
        You are a helpful AI assistant. A home inspection report has been generated, and the user has a question about it.
        ...
        Please answer in a helpful and clear manner.
        """
